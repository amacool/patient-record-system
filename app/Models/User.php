                                    ...
                                    CanResetPasswordContract
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'email', 'password', 'role', 'phone', 'country_code', 'company_id', 'created_by', 'tfa', 'oldid', 'active', 'favtemplate', 'standard_title', 'payment_missing', 'suspended'];
